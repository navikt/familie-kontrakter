...
enum class Ytelsestype(val kode: String, val navn: Map<Språkkode, String>) {
    ...
    OVERGANGSSTØNAD("EFOG", mapOf(Språkkode.NB to "Overgangsstønad",
                                Språkkode.NN to "Overgangsstønad")),
    BARNETILSYN("EFBT", mapOf(Språkkode.NB to "Stønad til barnetilsyn",
                            Språkkode.NN to "Stønad til barnetilsyn")),
    SKOLEPENGER("EFSP", mapOf(Språkkode.NB to "Stønad til skolepenger",
